...
def geocode_venue(venue_name: str, city: str = "Albuquerque", state: str = "NM") -> dict | None:
    """
...
def get_distance_between_points(lat1: float, lng1: float, lat2: float, lng2: float) -> float | None:
    """
...
if __name__ == "__main__":
    ...
    distance = get_distance_between_points(
        35.0781471, -106.6044161, 35.0833, -106.6197  # Isotopes Park  # The Pit
    )
