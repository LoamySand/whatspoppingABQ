...
def collect_baseline_traffic():
    ...
    if result["collected"]:
        ...
        return {"skipped": True, "reason": result.get("reason", "Not collection time")}
...
def event_traffic_flow():
    ...
    print("[OK] Event traffic collection complete")
...
def baseline_traffic_flow():
    ...
    if result.get("skipped"):
        ...
        print("[OK] Baseline traffic collection complete")
...
if __name__ == "__main__":
    ...
    validate_env(
        "database", "tomtom", service_name="Traffic collection flows (flows/collect_traffic.py)"
    )
