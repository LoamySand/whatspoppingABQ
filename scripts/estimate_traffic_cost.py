...
from collectors.traffic_collection_rules import estimate_monthly_api_calls
...
print(
    f"Events with traffic collection: {estimate['events_processed'] - estimate['events_skipped']}"
)
