...
def scrape_event_detail(driver, url: str) -> dict | None:
...
def extract_category(detail_list) -> str | None:
...
def parse_single_date(date_str: str) -> str | None:
...
def parse_single_time(time_str: str) -> str | None:
