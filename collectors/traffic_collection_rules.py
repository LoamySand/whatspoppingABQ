...
MINOR_CATEGORIES = ["General", "Arts & Culture", "Theater", "Food & Drink", "Food, Wine & Beer"]
...
COLLECTION_RULES = {
    ...
    "no_time": {"skip": True},  # Skip events without times
}
...
def get_collection_plan(event: dict) -> dict:
    ...
    if not event.get("event_start_time"):
        return {"collect": False, "reason": "No event time available"}
